...
@interface FriendsViewController ()<UITableViewDataSource,UITableViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,dailyRecodDelegate>
...
- (void)headAction {
    MyHomePageViewController *my = [[MyHomePageViewController alloc] init];
