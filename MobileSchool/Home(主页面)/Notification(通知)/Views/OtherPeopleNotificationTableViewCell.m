//
//  OtherPeopleNotificationTableViewCell.m
//  MobileSchool
//
...
@implementation OtherPeopleNotificationTableViewCell
...
+ (OtherPeopleNotificationTableViewCell *)otherPeopleNotificationTableViewCell:(UITableView *)tableView {
    static NSString *reuse = @"OtherNotificationreuse";
    OtherPeopleNotificationTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuse];
    if (!cell) {
        cell = [[OtherPeopleNotificationTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuse];
    };
