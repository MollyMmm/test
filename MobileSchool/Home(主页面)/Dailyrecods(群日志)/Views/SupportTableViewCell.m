...
- (void)createView {
    ...
    _readImageView.image = [UIImage imageNamed:@"未赞"];
...
+ (SupportTableViewCell *)tableViewCell:(UITableView *)tableView {
    static NSString *reuse = @"SupportReuse";
    SupportTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuse];
    if (!cell) {
        cell = [[SupportTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuse];
    }
    return cell;
}
